...
public class DataAbsent implements Persistable<Long>, UpdateAvailable<DataAbsent> {
    ...
    public static class Builder {
        ...
        public static Builder createNewRecord(Long idUser, Long idIndustry, LocalDateTime checkInTime) {
            return new Builder().newRecord(true)
                .idUser(Objects.requireNonNull(idUser, "id user tidak boleh kosong"))
                .idIndustry(Objects.requireNonNull(idIndustry, "id industry tidak boleh kosong"));
        }
