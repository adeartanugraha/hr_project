...
public class HrArapPaymentHandler {
    ...
    public HrArapPaymentBody createArapPayment(HrArapPaymentBody body) {
        var hrArapPayment = saveNewHrArapPayment(body);
        return HrArapPaymentBody.formArapPayment(hrArapPayment);
    }

    private HrArapPayment saveNewHrArapPayment(HrArapPaymentBody body) {
        var hrArapPayment = new HrArapPayment();
        hrArapPayment.id = body.getIdHrArapPayment();
        hrArapPayment.idArapMain = body.getIdArapMain();
        ...
        hrArapPayment.idContact = body.getIdContact();
        ...
        hrArapPayment.idEmployee = body.getIdEmployee();
