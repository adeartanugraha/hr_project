...
public class HrPositionApi {
    ...
    public Mono<HrPosition> createDataDepartment(HrPositionForm form) {
        ...
        .flatMap(f -> {
            HrPositionCrude.Option option = HrPositionCrude.initOption(f.convertNewRecord());
    ...
    public Flux<HrPosition> getAllDataDepartment(CommonParam param) {
        var sql = SelectQBuilder.builderWithCommonParam(HrPosition.TABLE_NAME, param)
            .build();
    ...
    public Mono<HrPosition> getDataDepartment(Long id) {
        var sql = SelectQBuilder.emptyBuilder(HrPosition.TABLE_NAME)
    ...
    public Mono<HrPosition> updateDataDepartment(Long id, HrPositionForm form) {
        return Mono.zip(Mono.just(id), Mono.just(form))
            ...
            .flatMap(d -> {
                HrPositionCrude.Option option = HrPositionCrude.initOption(d.convertNewRecord());
                return Mono.just(option);
            })
