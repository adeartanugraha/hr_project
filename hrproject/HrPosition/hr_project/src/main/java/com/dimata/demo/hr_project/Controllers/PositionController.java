...
public class PositionController {
  ...
  @PostMapping(
    path = BASE_URL + "/department",
    consumes = MediaType.APPLICATION_JSON_VALUE
  )
  public Mono<HrPosition> maintainerAddDataDepartment(
    @RequestBody HrPositionForm form
  ) {
  ...
  public Mono<HrPosition> maintainerGetDataDepartment(
  ...
  public Mono<HrPosition> maintainerUpdateDataDepartment(
    @PathVariable("DEPARTMENT_ID") long departmentId,
    @RequestBody HrPositionForm form
  ) {
